...
const InfoSection = () => {
  ...
  return (
    <section className="md:py-[130px] py-[50px]">
      <h2
        className="text-[#EB7400]/80 md:text-xl text-base font-normal leading-normal md:mb-[37px] mb-5"
      ...
      <div className="flex flex-col md:flex-row w-full md:gap-12 gap-0">
        <div className="w-full md:w-1/2">
          <div
            className="flex items-end border-b-2 border-[#8D9B00] justify-between pb-4"
            onMouseOver={() => setCursorSize(80)}
            onMouseLeave={() => setCursorSize(40)}
          >
          ...
          <div
            className="flex items-end border-b-2 border-[#8D9B00] justify-between md:py-6 py-3"
            onMouseOver={() => setCursorSize(80)}
            onMouseLeave={() => setCursorSize(40)}
          >
        ...
        <div className="w-full md:w-1/2">
          <div
            className="flex items-end border-b-2 border-[#8D9B00] justify-between md:pb-3 pb-4 md:py-0 md:pt-1 pt-3"
            onMouseOver={() => setCursorSize(80)}
            onMouseLeave={() => setCursorSize(40)}
          >
